...
const UserLogin = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen w-full">
      ...
      <div className="flex flex-col my-6 space-y-6 relative w-full max-w-lg mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="flex flex-col justify-center items-center text-white">
          <div className="flex items-center space-x-2">
            <span className="flex w-10 h-10 sm:w-14 sm:h-14 justify-center items-center">
              <IntelliscrapeIcon />
            </span>
        ...
        <div className="backdrop-blur-xs bg-slate-800/50 flex flex-col p-6 sm:p-8 border border-gray-700 rounded-xl w-full shadow-lg">
          ...
          <form
            ...
            className="flex mt-4 flex-col w-full gap-4"
          >
                ...
                <div className="relative mt-2 w-full">
                  <span className="absolute inset-y-0 left-3 flex items-center text-gray-400">
                    <svg
                      ...
                      xml:space="preserve"
                      stroke="#b0b0b0"
                      className="w-3 h-3 sm:w-4 sm:h-4 font-bold text-gray-300"
                      fill="currentColor"
                      aria-hidden="true"
                    >
                      ...
                      <g id="SVGRepo_iconCarrier">
                        ...
                        <g>
                          <g>
                            <path d="M426.272,331.529c-45.48-45.48-105.952-70.529-170.272-70.529c-64.32,0-124.791,25.047-170.273,70.529 c-45.48,45.481-70.529,105.952-70.529,170.272c0,5.632,4.566,10.199,10.199,10.199h461.204c5.632,0,10.199-4.567,10.199-10.199 C496.801,437.482,471.752,377.01,426.272,331.529z M35.831,491.602C41.179,374.789,137.889,281.398,256,281.398 s214.821,93.391,220.17,210.204H35.831z"></path>
                          </g>
                        </g>
                        <g>
                          <g>
                  ...
                  <input
                    ...
                    className="w-full pl-9 sm:pl-10 pr-4 py-2 bg-[#0b1b2b] text-white text-xs sm:text-sm md:text-base rounded-md 
