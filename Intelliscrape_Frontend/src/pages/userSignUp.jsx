...
const UserSignUp = () => {
  ...
  return (
              ...
              <div className="flex flex-col space-y-1">
                ...
                <div className="relative w-full">
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full pl-9 sm:pl-10 pr-4 py-3 bg-[#0b1b2b] text-white text-xs flex items-center md:text-sm lg:text-base rounded-md 
    ...
    focus:outline-none focus:shadow-[0_0_10px_rgba(0,255,255,0.6)] transition-all duration-150"
                ...
                >
                  Must be at least 8 characters with mixed case, numbers &
                  symbols
                </label>
              </div>
            ...
            <div className="w-5/6">
              <button
                ...
                className="w-full backdrop-blur-md cursor-pointer bg-slate-700/80 py-2 md:py-2 lg:py-3 px-4 text-white font-semibold rounded-md text-xs md:text-sm lg:text-base"
              >
